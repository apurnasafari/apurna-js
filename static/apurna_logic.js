...
execute_function = function(function_name /*, args */) {
  ...
  if(is_function(function_name) == false) {
    ...
    ApurnaConsole.debug('execute_function()', function_name + ' is not a function!');
    return false;
  }
...
WIPexecute_function_from_string = function(function_name /*, args */) {
  ...
  if(is_function(func) == false) {
    ApurnaConsole.debug('execute_function_from_string()', function_name + ' is not a function!');
    return false;
  }
...
execute_function_from_string = function(function_name, context /*, args */) {
  ...
  if(is_function(context[func]) == false) {
    // Leave this notice here for debugging
    ApurnaConsole.debug(function_name + ' is NOT a function! Called with execute_function_from_string()');
    return false;
  }
...
parse_str = function(value) {
  ...
  try {
    ...
    ApurnaConsole.exception('parse_str()', error);
...
parse_javascript = function(value) {
  ...
  try {
    ...
    ApurnaConsole.exception('parse_javascript() trying parse_float()', error);
  }
  ...
  try {
    ...
    ApurnaConsole.exception('parse_javascript() trying parse_int()', error);
  }
...
calc_float = function(value_a, operation, value_b) {
  ...
  try {
    ...
    if(operatorMap.hasOwnProperty(operation)) {
      ...
      ApurnaConsole.exception(`calc_float() operator ${operation} not recognized`);
    }

  }
  catch {
    ApurnaConsole.exception(`calc_float()`);
  }
