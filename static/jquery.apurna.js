...
/**
 * Data storage for jQuery.apurna.js functions
 */
var jQueryApurna = function() {
...
jQuery.extend(jQuery.fn, {
  ...
  bindFocusElements: function(element_parents, callback) {
    ...
    jQueryApurna.bindFocusElementsOptions = {
  ...
  checkFocusElements: function(element) {
    ...
    var options  = jQueryApurna.bindFocusElementsOptions;
    var selected = false;
  ...
  /**
   * Bind Form Change
   * @note used for ApurnaComponent.js
   *
