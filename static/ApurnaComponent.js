 ...
 * @version v2.0.0
 */
class ApurnaComponent {

  // Vars
  console      = ApurnaConsole;
  ...
  constructor(options) {
    ...
    if(is_empty(options.wrapper) === true) {
      throw new Error('Wrapper is not defined for ApurnaComponent');
    }
  ...
  serialize_form(form_element = null, params_output = false) {
    ...
    if(form_element == null) {
      console.error('Form element required for ApurnaComponent.serialize_form()');
      return false;
    }
  ...
  validateComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).validateComplete()', payload);
  ...
  validateError = function(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).validateError()', payload);
  ...
  saveComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).saveComplete()', payload);
  ...
  saveError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).saveError()', payload);
  ...
  cancelComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).cancelComplete', payload);
  ...
  cancelError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).cancelError', payload);
  ...
  archive(event, target) {
    ...
    this.console.debug(this.get_class_name() + '(ApurnaComponent).archive()');
  ...
  archiveComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).archiveComplete()', payload);
  ...
  archiveError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).archiveError()', payload);
  ...
  discard(event, target) {
    ...
    this.console.debug(this.get_class_name() + '(ApurnaComponent).discard()');
  ...
  discardComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).discardComplete()', payload);
  ...
  discardError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).discardError()', payload);
  ...
  sortComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).sortComplete', payload);
  ...
  sortError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).sortError()', payload);
  ...
  loadComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).loadComplete()', payload);
  ...
  loadError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).loadError()', payload);
  ...
  reloadComplete(event, payload, xhr, target, callback) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).reloadComplete()', payload);
  ...
  reloadError(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(ApurnaComponent).reloadError()', payload);
